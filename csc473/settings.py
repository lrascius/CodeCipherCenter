"""
Django settings for csc473 project.
...
SECRET_KEY = 'i@z!2n^z9al)v^@yz^f+yh5$4sic8o)*&kx6t@azt^30*85zf&'
...
STATIC_URL = '/cccenter/static/'
STATIC_ROOT = 'staticfiles'

STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'cccenter/static'),
)
